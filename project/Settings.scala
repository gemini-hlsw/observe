...
object Settings {
  ...
  object LibraryVersions {
    ...
    // Gemini Libraries
    val lucumaCore      = "0.94-1ade72a-20240318T193405Z-SNAPSHOT"
    val lucumaUI        = "0.94.3-3-d1a683e-20240318T203947Z-SNAPSHOT"
    val lucumaSchemas   = "0.77.0-4-bc2dce9-20240318T193536Z-SNAPSHOT"
