...
object DhsKeywordName {
  ...
  /** @group Constructors */
  case object INSTRUMENT extends DhsKeywordName("INSTRUMENT", KeywordName.INSTRUMENT, "instrument")

  /** @group Constructors */
  case object OBSID extends DhsKeywordName("OBSID", KeywordName.OBSID, "obsid")

  /** @group Constructors */
  case object TELESCOP extends DhsKeywordName("TELESCOP", KeywordName.TELESCOP, "telescope")

  /** @group Constructors */
  case object FRMSPCYCL extends DhsKeywordName("FRMSPCYCL", KeywordName.FRMSPCYCL, "FRMSPCYCL")

  /** @group Constructors */
  case object HDRTIMING extends DhsKeywordName("HDRTIMING", KeywordName.HDRTIMING, "HDRTIMING")

  /** @group Constructors */
  case object A_TDETABS extends DhsKeywordName("A_TDETABS", KeywordName.A_TDETABS, "A_TDETABS")
