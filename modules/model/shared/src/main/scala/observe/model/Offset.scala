...
object OffsetConfigResolver             {
  ...
  implicit object TelescopeOffsetConfigResolverP extends TelescopeOffsetConfigResolver[Axis.P] {
    val configItem = "p"
  }
  implicit object TelescopeOffsetConfigResolverQ extends TelescopeOffsetConfigResolver[Axis.Q] {
    val configItem = "q"
  }
  ...
  implicit object NSOffsetConfigResolverAP  extends NSOffsetConfigResolverA[Axis.P] {
    val configItem = "nsBeamA-p"
  }
  implicit object NSOffsetConfigResolverAQ  extends NSOffsetConfigResolverA[Axis.Q] {
    val configItem = "nsBeamA-q"
  }
  sealed trait NSOffsetConfigResolverB[A]   extends NSOffsetConfigResolver[OffsetType.NSNodB, A]
  implicit object NSOffsetConfigResolverBP  extends NSOffsetConfigResolverB[Axis.P] {
    val configItem = "nsBeamB-p"
  }
  implicit object NSOffsetConfigResolverBQ  extends NSOffsetConfigResolverB[Axis.Q] {
