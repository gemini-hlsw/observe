...
object Event {
  ...
  def start[F[_]](id: Observation.Id, user: User, clientId: ClientId): Event[F] =
    EventUser[F](Start[F](id, user.some, clientId))
  def pause[F[_]](id: Observation.Id, user: User): Event[F]                     =
    EventUser[F](Pause(id, user.some))
  def cancelPause[F[_]](id: Observation.Id, user: User): Event[F]               =
  ...
  def failed[F[_]](id: Observation.Id, i: Int, e: Result.Error): Event[F]  =
  ...
  def paused[F[_]](id: Observation.Id, i: Int, c: Result.Paused): Event[F] =
    EventSystem[F](Paused(id, i, c))
  def breakpointReached[F[_]](id: Observation.Id): Event[F]                =
    EventSystem[F](BreakpointReached(id))
  def sequencePaused[F[_]](obsId: Observation.Id): Event[F]                =
    EventSystem[F](SequencePaused(obsId))
  def busy[F[_]](id: Observation.Id, clientId: ClientId): Event[F]         =
    EventSystem[F](Busy(id, clientId))
  def executed[F[_]](id: Observation.Id): Event[F]                         =
    EventSystem[F](Executed(id))
  def executing[F[_]](id: Observation.Id): Event[F]                        =
    EventSystem[F](Executing(id))
  def stepComplete[F[_]](id: Observation.Id): Event[F]                     =
    EventSystem[F](StepComplete(id))
  def finished[F[_]](id: Observation.Id): Event[F]                         =
