...
object TestAltairEpics {
  ...
  val defaultState: State = State(
    ...
    lgsfexp = 0.0,
    btoLoop = "OFF",
    strapGateControlCmd = TestEpicsCommand1.State[Int](mark = false, 0),
    strapControlCmd = TestEpicsCommand1.State[Int](mark = false, 0),
    sfoControlCmd = TestEpicsCommand1.State[LgsSfoControl](mark = false, LgsSfoControl.Disable),
    btoControlCmd = TestEpicsCommand1.State[String](mark = false, "OFF")
  )
