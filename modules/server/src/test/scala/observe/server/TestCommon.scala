...
object TestCommon {
  ...
  val defaultSettings: ObserveEngineConfiguration = ObserveEngineConfiguration(
    ...
    failAt = 0,
    10.seconds,
    GpiSettings(uri"vm://localhost:8888/xmlrpc"),
    GpiSettings(uri"http://localhost:8888/xmlrpc"),
    GhostSettings(uri"vm://localhost:8888/xmlrpc"),
    GhostSettings(uri"http://localhost:8888/xmlrpc"),
    "",
    Some("127.0.0.1"),
    0,
    3.seconds,
